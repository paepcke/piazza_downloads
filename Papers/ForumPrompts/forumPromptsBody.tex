...
impact on the rest of the forum participants. The importance of
actively fostering interactions was shown in \cite{laba16}.
...
meetings. We might therefore expect that reactions to encouragement
...
might be used to improve the student learning experience. Such
analysis would quantitative as well as qualitative approaches. The
interpretation would have to include a value judgment on people's use
of the environment: not only counting who uses the environment for
what, but also judging what might be a good and what might be a bad
experience, and offering suggestions for moving on the continuum from
one to the other.
...
behaviors, complemented with those of their peers, and the assumed
theoretical ideal, could be used as a nudge. It is argued that if
...
Since 2011 many courses in the studied university have used the Piazza
forum facility for its internal courses. Our dataset comprises the
posts and comments of these usage years. From among 5000 university
course offerings that have used the Piazza forum facility since 2011
we selected twelve courses, with a total of around 40 offerings. We use
the term {\em offering} to denote a course taught during a particular
...
represent topic connections. Similarly, when user communication
...
quality, such as irrelevant postings, for which a richer model
would be required.
...
the forum or never replied to others' posts and never received replies on their posts.
...
positive. We chose these two measures because of their relatively
...
enough signals. Because of space constraints we focus in the following
material on the weighted out-degree to explore its contributions to
insights into student behavior.

\section{Analysis Procedure}

For each course we identified the top 10\% of students who contributed
...
\begin{figure}[]
       ...
       \caption{\textnormal{CUSUMs from permuted weekly post
           contribution rates hover around the mean.} The green
           line indicates the number of posts.}
...
Each row in Table~\ref{tbl:consistency} shows to which degree
offerings of that row's course over the years showed consistent
changes in behaviors of the top-10\% contributors. The percentages in
a week's column indicate the proportion of the respective course's
offerings that experienced jumps during that week.
\begin{table*}[htbp]
\centering
\caption{Consistency of behavior changes across offerings in weeks with change points.}
\label{tbl:consistency}
\begin{tabular}{lcccccccc}
{\bf Course}                                                                                           & \multicolumn{1}{l}{Week3} & \multicolumn{1}{l}{Week4} & \multicolumn{1}{l}{Week5} & \multicolumn{1}{l}{Week6} & \multicolumn{1}{l}{Week7} & \multicolumn{1}{l}{Week8} & \multicolumn{1}{l}{Week9} & \multicolumn{1}{l}{Week10} \\ \cline{2-9} 
\multicolumn{1}{l|}{AI Principles (6)}                                                               & \multicolumn{1}{c|}{17\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{50\%} & \multicolumn{1}{c|}{16\%} & \multicolumn{1}{c|}{33\%} & \multicolumn{1}{c|}{}      \\ \cline{2-9} 
\multicolumn{1}{l|}{Machine Learning (7)}                                                            & \multicolumn{1}{c|}{50\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{14\%} & \multicolumn{1}{c|}{14\%} & \multicolumn{1}{c|}{14\%} & \multicolumn{1}{c|}{28\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}      \\ \cline{2-9} 
\multicolumn{1}{l|}{Computer Vision (4)}                                                             & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{50\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}      \\ \cline{2-9} 
\multicolumn{1}{l|}{Decision Analysis (2)}                                                           & \multicolumn{1}{c|}{50\%} & \multicolumn{1}{c|}{50\%} & \multicolumn{1}{c|}{50\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{50\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}      \\ \cline{2-9} 
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Algorithms for
    \\ Molecular Biology (6)\end{tabular}} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{33\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}      \\ \cline{2-9} 
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}International
    \\ Urbanization (5)\end{tabular}}       & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{20\%} & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}     & \multicolumn{1}{c|}{}      \\ \cline{2-9} 
\end{tabular}
\end{table*}
The results indicate that week six is particularly likely to
experience changes in posting rates. Given that the university
operates on a quarters schedule, we can hypothesize that the traffic
is related to midterms. Week eight might be related to final projects
coming due not too far out. Note, however, that the number of
offerings (shown in parentheses with the course names) differ across
courses. Thus 20\% for urban studies means only one of five offerings
experienced a significant posting acceleration.

The only courses with an appreciable number of change points among
their offerings are engineering courses. The humanities and social
sciences, while using forum facilities, have not included the forum as
a central discussion hub. The numbers of students attending these
courses are also smaller than the science/engineering classes.
...
such level is known from the domain, a mean can be used. Our process
limits denote $2*\sigma$ distance from the mean.
...
personalizing the message, and providing a tool for planning. Studies
are needed to determine whether postings in response to even such
personalized messages prove beneficial.
...
and relate students' final grade to their engagement in MOOCS. 
...
A further use of page rank will be to observe how teaching
